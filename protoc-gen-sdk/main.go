...
var (
	_                          = flag.String("go_pkg", "", "override the go package specified in the proto file")
...
func main() {
	...
	protogen.Options{
		...
		generator := gensdk.New(reg, *useRequestContext, *registerFuncSuffix, *allowPatchFeature, *standalone)
